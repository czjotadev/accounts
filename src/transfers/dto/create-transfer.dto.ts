...
export class CreateTransferDto {
  ...
  @IsInt({
    message:
      'O campo "Número da conta de Origem" precisa ser um número inteiro.',
  })
  @IsNotEmpty({ message: 'O campo "Número da conta de Origem" é obrigátorio.' })
  @IsPositive({
    message:
      'O campo "Número da conta de Origem" precisa ser um número positivo.',
  })
  @Max(99999, {
    message:
      'O tamanho máximo do campo "Número da conta de Origem" é de 5 caracteres.',
  })
  ...
  @IsInt({
    message:
      'O campo "Número da conta de destino" precisa ser um número inteiro.',
  })
  @IsNotEmpty({
    message: 'O campo "Número da conta de destino" é obrigátorio.',
  })
  @IsPositive({
    message:
      'O campo "Número da conta de destino" precisa ser um número positivo.',
  })
  @Max(99999, {
    message:
      'O tamanho máximo do campo "Número da conta de destino" é de 5 caracteres.',
  })
